 ...
 * @param {string[]} dictionary - Array of dictionary strings to compare against
 * @returns {string[]} Array of queries that have at most 2 character differences with at least one dictionary word
 */
